...
public class units_complete_reportModel : PageModel
{
    public populatetable Data { get; set; }
    // Public property to hold the hardcoded text
    public string HardcodedText { get; set; }

    public units_complete_reportModel(ILogger<units_complete_reportModel> logger)
    {
        // Initialize the hardcoded text
        HardcodedText = "Vista Units Completed Report";
    }
